            ...
            <div class="col-md-8">
                ...
                <div class="tab-content">
                    ...
                    <?php if (!$model->isNewRecord) {
                        $getValue = \common\models\Page::getValue($_GET['id'], $lang->lang_code);
                    }?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group required-field">
                                        <?= $form->field($model, "body[$lang->lang_code]")
                                            ->textarea(['value'=>(!$model->isNewRecord)?$getValue['body']:'','id' => 'tiny-editor-description', 'data-tinymce' => "compact", 'data-height' => "500"])
